...
# Configurations which define the CPI support functions.
Configs += cps
UniversalArchs.cps = $(call CheckArches,x86_64,cps)

Configs += cpi
UniversalArchs.cpi = $(call CheckArches,x86_64,cpi)

# Configurations which define the safestack support functions.
Configs += safestack
UniversalArchs.safestack = $(call CheckArches,x86_64,safestack)
...
CFLAGS.cps		:= $(CFLAGS) -fno-rtti -fno-exceptions -fno-builtin \
...
CFLAGS.safestack		:= $(CFLAGS) -fno-rtti -fno-exceptions -fno-builtin \
    			   -fno-cpi -fno-stack-protector \
			   -g -DNDEBUG
...
FUNCTIONS.cps := $(CPIFunctions)

FUNCTIONS.cpi := $(CPIFunctions)

FUNCTIONS.safestack := $(SafeStackFunctions) $(InterceptionFunctions)
